...
if [ ! -d /data/.frenkowski ]; then
	$BB mkdir -p /data/.frenkowski;
	$BB chmod -R 0777 /.frenkowski/;
else
	$BB rm -rf /data/.frenkowski/*
	$BB chmod -R 0777 /.frenkowski/;
fi;
...
if [ -e /data/.frenkowski/Kernel-test.log ]; then
	rm /data/.frenkowski/Kernel-test.log;
fi;
echo  Kernel script is working !!! >> /data/.frenkowski/Kernel-test.log;
echo "excecuted on $(date +"%d-%m-%Y %r" )" >> /data/.frenkowski/Kernel-test.log;
